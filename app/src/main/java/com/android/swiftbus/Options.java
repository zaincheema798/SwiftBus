                    ...
                    public void onError(@NonNull GetCredentialException exception) {
                        ...
                        runOnUiThread(() -> {
                            ...
                            if (!isFinishing() && !isDestroyed()) {
                                Toast.makeText(Options.this, "Google Sign-In failed", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
    ...
    private void handleSignIn(Credential credential) {
        ...
        if (credential instanceof CustomCredential customCredential
            ...
            try {
                ...
                runOnUiThread(() -> {
                    if (!isFinishing() && !isDestroyed()) {
                        Toast.makeText(Options.this, "Authentication error", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        } else {
            ...
            runOnUiThread(() -> {
                if (!isFinishing() && !isDestroyed()) {
                    Toast.makeText(Options.this, "Invalid credential type", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
        ...
        auth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(Options.this, errorMessage, Toast.LENGTH_SHORT).show();
                    }
                });
    }
